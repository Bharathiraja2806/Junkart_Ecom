# Generated by Django 5.0.6 on 2025-01-30 16:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accountsapp', '0002_category_product'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accountsapp.product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('items', models.ManyToManyField(to='accountsapp.orderitem')),
            ],
        ),
    ]
